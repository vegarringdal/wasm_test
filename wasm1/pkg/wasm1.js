...
/**
* @param {any} filter_input
* @returns {number}
*/
export function json_data(filter_input) {
    const ret = wasm.json_data(addHeapObject(filter_input));
    return ret;
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('wasm1_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
